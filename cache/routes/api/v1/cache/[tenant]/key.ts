...
export const post = [
    ...
    async (req: Request, res: Response) => {
        ...
        try{
            ...
            Logger.debug('Did not successfully validate key upload schema')
        ...
        if(signing_key_db !== null){
            ...
            try{
                ...
                return res.status(500).json(MakeRestResponse(
                    ...
                    true,
                    {
                        'error_description': "Iglu encountered an error while trying to update your signing key, try again later or check the logs"
                    }
                ))
            }
        }
