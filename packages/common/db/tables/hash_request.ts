        ...
        SELECT hr.id,
               ...
               (SELECT hcl.id,
                       ...
                       (SELECT json_build_object(
                                       ...
                                       'creator_api_key', (SELECT json_build_object(
                                                                          'id', ak.id,
                                                                          'user', row_to_json(u.*),
                                                                          'name', ak.name,
                                                                          'hash', ak.hash,
                                       ...
                                       (SELECT json_build_object('id', cskl.id, 'cache', row_to_json(c.*),
                                                                 'signingkey', (SELECT json_build_object(
                                                                                               'id', psk.id,
                                                                                               'api_key',
                                                                                               json_build_object(
                                                                                                       'id',
