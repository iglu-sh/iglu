...
import { deployment_keys, deployments, tenants } from "../../schema_pg";
import type { deployment_abstract } from "../abstracts/deployment_abstract";

export class postgres_deployment implements deployment_abstract {
    ...
    public async insert(item: deployment): Promise<deployment> {
        return await this.db.transaction(async (tx) => {
            ...
            if (!inserted[0]) {
                Logger.error(
                    "panic(DAO::deployments::postgres_deployments): Could not insert into Database: Did not get returning value from insert statement",
                );
                throw new Error(
                    "panic(DAO::deployments::postgres_deployments): Could not insert into Database: Did not get returning value from insert statement",
                );
            ...
            return await tx
                ...
                .then((res) => {
                    if (!res[0]) {
                        Logger.error(
                            "Panic(DB::DAO::deployments::postgres_deployments): Did not receive inserted item from Database",
                        );
                        throw new Error(
                            "Panic(DB::DAO::deployments::postgres_deployments): Did not receive inserted item from Database",
                        );
    ...
    public async update(item: deployment): Promise<deployment> {
        return await this.db.transaction(async (tx) => {
            ...
            if (!updated[0]) {
                Logger.error(
                    "panic(DAO::deployments::postgres_deployments): Could not update record: Did not get anything from update statement as returning value",
                );
                throw new Error(
                    "panic(DAO::deployments::postgres_deployments): Could not update record: Did not get anything from update statement as returning value",
                );
            ...
            return await tx
                ...
                .then((res) => {
                    if (!res[0]) {
                        Logger.error(
                            "panic(DAO::deployments::postgres_deployments): Could not update record: Did not get anything from select statement",
                        );
                        throw new Error(
                            "panic(DAO::deployments::postgres_deployments): Could not update record: Did not get anything from select statement",
                        );
