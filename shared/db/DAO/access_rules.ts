...
export default class Access_Rules extends DAO<access_rule> {
     ...
     * */
    public override async getAll(): Promise<Array<access_rule>> {
     ...
     * */
    public override async getById(id: string): Promise<access_rule | null> {
     ...
     */
    public override async update(to_update: access_rule): Promise<access_rule> {
        let return_item: undefined | access_rule;
     ...
     * */
    public override async delete(to_delete: access_rule): Promise<void> {
